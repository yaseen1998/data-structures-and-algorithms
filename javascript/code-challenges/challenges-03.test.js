...
const typeNum = (arr) => {
  // Solution code here...
  const result = arr.filter(arr => typeof(arr)=='number');
  return result
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let result = arr.filter(arr => arr.includes('and'))
  return result
};
...
const oddValues = (arr) => {
  // Solution code here...
  let result = arr.filter(arr => arr%2==1)
  return result
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let result =arr.filter(arr=>!(forbiddenValues.includes(arr)))
  return result
};
